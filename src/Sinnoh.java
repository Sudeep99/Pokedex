 ...
 * @author Sudeep99
 */
public class Sinnoh extends javax.swing.JFrame {

    /**
     * Creates new form Sinnoh
     */
    public Sinnoh() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sinnoh");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(240, 20, 150, 60);
        ...
        jButton3.setBounds(40, 500, 100, 40);
        ...
        jButton4.setBounds(390, 500, 140, 40);
        ...
        jButton1.setBounds(280, 500, 100, 40);
        ...
        jScrollPane1.setBounds(80, 110, 452, 200);
        ...
        jButton6.setBounds(150, 500, 120, 40);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pokedex/icons/Sinnoh_Background.jpg"))); // NOI18N
        getContentPane().add(jLabel5);
        jLabel5.setBounds(-160, -50, 810, 710);
    ...
    try{
        ...
        String selectQuery = "Select * from sinnoh where Pokemon='"+name+"'";
        /* Query to get the sinnoh table from pokedex database where pokemon is taken from TextField one*/
    ...
    try{
        ...
        /* Initialize connection with MYSQL access the database pokedex with MYSQL username and password*/
        Statement stmt = conn.createStatement();
        String selectQuerty = "Select * from sinnoh where type like'%"+typeName+"%'";
        /* Query to get the sinnoh table from pokedex database where type is taken from TextField two*/
        ResultSet resultSet = stmt.executeQuery(selectQuerty);
        /* Put the recieved contents after successful execution of the statement String s in MYSQL in a ResultSet "resultSet" */ 
        DefaultTableModel tableModel = (DefaultTableModel)jt1.getModel();
        /* get the initialized table model from jt1*/
        while (resultSet.next()){// to loop through the result set
    ...
    try{
        ...
        /* Initialize connection with MYSQL access the database pokedex with MYSQL username and password*/
        Statement stmt=conn.createStatement();
        String selectQuery ="Select * from sinnoh";
        /* Query to get everything from the sinnoh table in the pokedex database */
        ResultSet resultSet = stmt.executeQuery(selectQuery);
        /* Put the recieved contents after successful execution of the statement String s in MYSQL in a ResultSet "resultSet" */ 
        DefaultTableModel tableModel = (DefaultTableModel)jt1.getModel();
        /* get the initialized table model from jt1*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sinnoh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
