 ...
 * @author Sudeep99
 */
public class Johto extends javax.swing.JFrame {

    /**
     * Creates new form Johto
     */
    public Johto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(120, 390, 90, 30);
        ...
        jScrollPane1.setBounds(70, 110, 452, 200);
        ...
        t1.setBounds(210, 330, 270, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 48)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Johto");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(240, 10, 140, 60);
        ...
        jButton2.setBounds(260, 360, 90, 30);
        ...
        jButton3.setBounds(50, 480, 100, 40);
        ...
        jButton4.setBounds(400, 480, 140, 40);
        ...
        jButton5.setBounds(260, 420, 90, 30);
        ...
        jButton6.setBounds(160, 480, 120, 40);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pokedex/icons/Johto_Background.jpg"))); // NOI18N
        getContentPane().add(jLabel6);
        jLabel6.setBounds(-110, -30, 780, 720);
    ...
    try{
        ...
        String selectQuery = "Select * from johto where Pokemon='"+name+"'";
        /* Query to get the johto table from pokedex database where pokemon is taken from TextField */
        ...
        /* get the initialized table model from JTable jt1*/
    ...
    DefaultTableModel tableModel = (DefaultTableModel)jt1.getModel();// get the table model from JTable jt1
    ...
    dispose();// close the existing JFrame
    ...
    try{
        ...
        /* Initialize connection with MYSQL access the database pokedex with MYSQL username and password*/
        Statement stmt = conn.createStatement();
        String selectQuery = "Select * from johto where type like'%"+typeName+"%'";
        /* Query to get the johto table from pokedex database where type is taken from TextField two*/
        ResultSet  resultSet = stmt.executeQuery(selectQuery);
        /* Put the recieved contents after successful execution of the statement String s in MYSQL in a ResultSet "resultSet" */ 
        DefaultTableModel tableModel = (DefaultTableModel)jt1.getModel();
    ...
    try{
        ...
        /* Initialize connection with MYSQL access the database pokedex with MYSQL username and password*/
        Statement stmt = conn.createStatement();
        String selectQuery = "Select * from johto";
        /* Query to get everything from the johto table in the pokedex database */
        ResultSet  resultSet = stmt.executeQuery(selectQuery);
        /* Put the recieved contents after successful execution of the statement String s in MYSQL in a ResultSet "resultSet" */ 
        DefaultTableModel tableModel=(DefaultTableModel)jt1.getModel();
        /* get the initialized table model from jt1*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Johto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
